...
class Program
{
    ...
    static async Task Main(string[] args)
    {
        ...
        services.AddTransient<PositionRunDetectionReport>();
    ...
    // report --combine FanProsCoreFields,zscores,FanProsDelta,MockMarketDelta,PositionDraftDistribution,PositionRunDetection
